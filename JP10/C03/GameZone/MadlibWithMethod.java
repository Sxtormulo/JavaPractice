void main()
{
    ...
    displayMadLib(firstWord, secondWord, thirdWord, fourthWord);
}

static void displayMadLib(String firstWord, String secondWord, String thirdWord, String fourthWord)
{
    String madlib = """
