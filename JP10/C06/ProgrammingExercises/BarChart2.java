...
/**
 * BarChart - Display the points scored for each basketball player in the season
 *
 * @author Sxtormulo
 ...
 * For each then points that their scored
...
public class BarChart2
{
    ...
    static final int TO_ASTERISK = 10;
    ...
    record BasketballPlayer(String name, int points)
        ...
        void dispayPoints()
        {
            int groupedPoints = points / TO_ASTERISK;
            String pointBar;
            pointBar =
                    IntStream.range(NO_POINTS, groupedPoints)
                            .mapToObj(i -> POINT)
